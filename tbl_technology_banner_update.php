                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-body">
                                ...
                                $sql_select = "SELECT * FROM tbl_technology_banner WHERE id=$id_para";
                                    $result = $con->query($sql_select);
                                    $row=mysqli_fetch_assoc($result);
                                    echo'
                                        <form action="" method="post" enctype="multipart/form-data">   
                                            <input value="'.$row['id'].'" type="hidden" id="old_id" name="updateid">
                                            <input value="'.$row['banner'].'" type="hidden" id="old_te_banner" name="old_te_banner">

                                            <div class="row mb-3">
                                                <label for="image" class="col-sm-2 col-form-label">Security Banner</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control image1" type="file" id="image" name="te_banner">
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                            ...
                                            <button type="submit" name="btn_update_te_banner" class="btn btn-info waves-effect waves-linght">Update New Banner</button>
...
$(document).ready(function(){
    $(".image1").change(function(e){
        ...
        $(".btn_update_te_banner").click(function(){
            var old_banner = $(this).parents("tr").find("td:eq(1)img").attr("alt");
            $("#old_te_banner").val(old_banner);
        })
    });
